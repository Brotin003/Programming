...
int main()
{
    ...
    char input;
    float kmsToMiles = 0.621371; // conversion factors
    ...
    while (1)
    {
        ...
        case '1':
            ...
            printf("%.2f Kms is equal to %.2f Miles\n\n\n", first, second);       // we can also use %2f for the less decimal characters
            break;
        ...
        case '4':
            ...
            printf("%.2f Pounds is equal to Kgs %.2f \n", first, second);
            break;
